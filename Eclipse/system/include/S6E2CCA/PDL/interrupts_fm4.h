...
// Include extif.h if active and interrupts are enabled.
#if (PDL_ON == PDL_INTERRUPT_ENABLE_EXTIF)
    #if defined(PDL_PERIPHERAL_EXTIF_ACTIVE)
        #include "extif/extif.h"
    #else
        #error Do not enable EXTIF interrupt when it is inactive.
    #endif
#endif

// Include hsspi.h if active and interrupts are enabled.
#if (PDL_ON == PDL_INTERRUPT_ENABLE_HSSPI)
    #if defined(PDL_PERIPHERAL_HSSPI_ACTIVE)
        #include "hsspi/hsspi.h"
    #else
        #error Do not enable HSSPI interrupt when it is inactive.
    #endif
#endif

// Include i2s.h if active and interrupts are enabled.
#if (PDL_ON == PDL_INTERRUPT_ENABLE_I2S0) || \
    (PDL_ON == PDL_INTERRUPT_ENABLE_I2S1)
    #if defined(PDL_PERIPHERAL_I2S_ACTIVE)
        #include "i2s.h"
    #else
        #error Do not enable I2S interrupt when it is inactive.
    #endif
#endif

// Include i2spll.h if active and interrupts are enabled.
#if (PDL_ON == PDL_INTERRUPT_ENABLE_I2SPLL)
    #if defined(PDL_PERIPHERAL_I2SPLL_ACTIVE)
        #include "i2spll.h"
    #else
        #error Do not enable I2SPLL interrupt when it is inactive.
    #endif
#endif
...
// Include pcrc.h if active and interrupts are enabled.
#if (PDL_ON == PDL_INTERRUPT_ENABLE_PCRC)
    #if defined(PDL_PERIPHERAL_PCRC_ACTIVE)
        #include "pcrc/pcrc.h"
    #else
        #error Do not enable PCRC interrupt when it is inactive.
    #endif
#endif
...
// Include qprc.h if active and interrupts are enabled.
    ...
    (PDL_ON == PDL_INTERRUPT_ENABLE_QPRC3)
...
// Include sd.h if active and interrupts are enabled.
    ...
    (PDL_ON == PDL_INTERRUPT_ENABLE_GDC_SDRAM)
        ...
        #include "sdif/sdif.h"
    #else
        #error Do not enable SD interrupt when it is inactive.
    #endif
#endif

// Include upll.h if active and interrupts are enabled.
#if (PDL_ON == PDL_INTERRUPT_ENABLE_UPLL)
    #if defined(PDL_PERIPHERAL_UPLL_ACTIVE)
        #include "upll.h"
    #else
        #error Do not enable UPLL interrupt when it is inactive.
    #endif
#endif
...
// Include wdg.h if active and interrupts are enabled.
    ...
    (PDL_ON == PDL_INTERRUPT_ENABLE_HWWDG)
		...
		(PDL_ON == PDL_INTERRUPT_ENABLE_DSTC_HWINT)
