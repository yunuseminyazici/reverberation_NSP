...
/* Change history:
 *  ter, Feb 07, 2019: 	Option for DSTC added in section 'User Interrupt activation settings'
 *  					#define PDL_INTERRUPT_ENABLE_DSTC_HWINT
 *  					Needed to activate HWINT DSTC interrupt handler for peripherals with separated
 *  					interrupt option (I2S, HS-SPICNT, CAN-FD and programmable CRC).
 *  					Will only work with a modified 'interrupts_fm4_type_b.c'
 */
...
#define PDL_INTERRUPT_ENABLE_DSTC_HWINT		   PDL_ON 	// Interrupt for separated type peripheral functions
...
// I2S
#define PDL_DSTC_ENABLE_I2S0_TX                 PDL_ON
#define PDL_DSTC_ENABLE_I2S0_RX                 PDL_ON
