...
/* Change history
 * ter, Feb 07, 2019: 	DSTC Handler for peripherals with separated interrupt handling
 * 						added (I2S, HS-SPICNT, CAN-FD and programmable CRC)
 *
 */
...
void PDL_DummyHandler(uint32_t);
 ...
 ******************************************************************************/
    ...
    void CAN1_CANFD0_IRQHandler(void)
    {
        ...
        #if (PDL_ON == PDL_INTERRUPT_ENABLE_CANFD)
        if (0ul != (u32IrqMon & 0x00000008ul))
        {
...
/******************************************************************************/
/************ FM4: DSTC peripherals with separated type interrupt *************/
/************ I2S, HS-SPICNT, CAN-FD and programmable CRC         *************/
/******************************************************************************/
#if (PDL_ON == PDL_INTERRUPT_ENABLE_DSTC_HWINT)
/**
 ******************************************************************************
 ** \brief FM4: DSTC_HW_IRQHandler (IRQ#112)
 ******************************************************************************/
