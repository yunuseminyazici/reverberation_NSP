...
/* Change History
 *
 * ter, Apr 8, 2019: 	Function I2s_GetStatus, Status bits for I2sTxFifoMatchThreshold,
                        ...
                        en_i2s_status_t enStatus)
{
    ...
    switch(enStatus)
    {
        ...
        case I2sRxFifoOverflow:
            bRet = (1u == pstcI2s->STATUS_f.RXOVR) ? TRUE : FALSE;
            break;     
        ...
        case I2sTxFifoMatchThreshold:
            bRet = (1u == pstcI2s->STATUS_f.TXFI) ? TRUE : FALSE;
            break;
        case I2sRxFifoMatchThreshold:
            bRet = (1u == pstcI2s->STATUS_f.RXFI) ? TRUE : FALSE;
            break;    
        default:
            break;
    }
