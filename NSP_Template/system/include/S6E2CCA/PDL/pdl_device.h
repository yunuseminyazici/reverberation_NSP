 ...
 **
 ** See pdl.h line 127 for choice list.
 **
 ** \note This definition is used for GPIO settings, interrupt vector,
 **       enumeration handling, and Type(1, 2, ...) Device handling.
 ******************************************************************************/
#define PDL_MCU PDL_DEVICE_TYPE_S6E2CCX
 ...
 ******************************************************************************/
#define PDL_PACKAGE PDL_DEVICE_PACKAGE_L
